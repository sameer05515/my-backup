...
--
-- Dumping data for table `t_catg_ques`
--

LOCK TABLES `t_catg_ques` WRITE;
/*!40000 ALTER TABLE `t_catg_ques` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_catg_ques` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_catg_ques_ans`
--

LOCK TABLES `t_catg_ques_ans` WRITE;
/*!40000 ALTER TABLE `t_catg_ques_ans` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_catg_ques_ans` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_catg_ques_read_history`
--

LOCK TABLES `t_catg_ques_read_history` WRITE;
/*!40000 ALTER TABLE `t_catg_ques_read_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_catg_ques_read_history` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-11-24 13:48:30
