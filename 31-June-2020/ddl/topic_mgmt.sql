...
--
-- Host: localhost    Database: topic_mgmt
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `topic_read_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Temporary table structure for view `vw-topic-for-list`
--

DROP TABLE IF EXISTS `vw-topic-for-list`;
/*!50001 DROP VIEW IF EXISTS `vw-topic-for-list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw-topic-for-list` (
  `ID` tinyint NOT NULL,
  `creation_date` tinyint NOT NULL,
  `last_updation_date` tinyint NOT NULL,
  `isprivate` tinyint NOT NULL,
  `rating` tinyint NOT NULL,
  `title` tinyint NOT NULL,
  `last_read_date` tinyint NOT NULL,
  `uniquestrid` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Dumping routines for database 'topic_mgmt'
--

--
-- Final view structure for view `vw-topic-for-list`
--

/*!50001 DROP TABLE IF EXISTS `vw-topic-for-list`*/;
/*!50001 DROP VIEW IF EXISTS `vw-topic-for-list`*/;
...
/*!50001 VIEW `vw-topic-for-list` AS select `topic`.`ID` AS `ID`,`topic`.`creation_date` AS `creation_date`,`topic`.`last_updation_date` AS `last_updation_date`,`topic`.`isprivate` AS `isprivate`,`topic`.`rating` AS `rating`,`topic`.`title` AS `title`,`topic`.`last_read_date` AS `last_read_date`,`topic`.`uniquestrid` AS `uniquestrid` from `topic` */;
...
-- Dump completed on 2020-12-27 23:24:33
